...
> **素材**：[#18 T2 决议](https://github.com/0xnicholas/heirloom-pro/issues/18) + [research/dsl-draft-generation](../research/dsl-draft-generation.md) §2（实证）；ADR-0007 决议 1（CLI 求值步同源）。
